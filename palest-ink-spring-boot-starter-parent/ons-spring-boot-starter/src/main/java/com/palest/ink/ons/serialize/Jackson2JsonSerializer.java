...
/**
 * @ fileName: Jackson2JsonSerializer.java
 * @ author: WeiHui
 * @ date: 2018/1/23 17:08
 * @ version: v1.0.0
 */
@Component("jackson2JsonSerializer")
public class Jackson2JsonSerializer implements Serializer<Object> {

	private final ObjectMapper mapper;

	/**
	 * Creates {@link Jackson2JsonSerializer} and configures {@link ObjectMapper} for default typing.
	 */
	...
	/**
	 * Creates {@link Jackson2JsonSerializer} and configures {@link ObjectMapper} for default typing using the
	 * given {@literal name}. In case of an {@literal empty} or {@literal null} String the default
	 * {@link JsonTypeInfo.Id#CLASS} will be used.
	 *
	 * @param classPropertyTypeName Name of the JSON property holding type information. Can be {@literal null}.
	 */
	public Jackson2JsonSerializer(@Nullable String classPropertyTypeName) {
	 ...
	 */
	public Jackson2JsonSerializer(ObjectMapper mapper) {
	 ...
	 * {@link Jackson2JsonSerializer} by providing an external {@link ObjectMapper}.
	 *
