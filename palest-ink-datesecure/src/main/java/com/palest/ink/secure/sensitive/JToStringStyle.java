...
/**
 * 类JToStringStyle.java的实现描述：
 * 
 * @author huanglifang Jul 15, 2017 11:39:39 PM
 */
public abstract class JToStringStyle implements Serializable {
    ...
    private static final class JsonToStringStyle extends ToStringStyle {
        ...
        private void appendValueAsString(StringBuffer buffer, String value) {
            if (StringUtils.isBlank(value) || value.startsWith(getArrayStart()) && value.endsWith(getArrayEnd())
                    || value.startsWith(getContentStart()) && value.endsWith(getContentEnd())) {
                buffer.append(value);
            } else {
                buffer.append("\"" + value + "\"");
            }
